...
class TemperatureMachine(StateMachine):
    ...
    def setupSerialOutput(self):
        ...
        if self.current_state == self.heat:
            ...
            state_str = "OFF"
        output = f"{state_str},{temp:.1f},{self.setPoint}"
        return output
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            ## Remove this TODO comment block when complete.
            ##
            line1 = current_time.strftime("%H:%M:%S")
            ...
            if (altCounter < 6):
                ...
                if self.current_state == self.heat:
                    ...
                    state_str = "OFF"
                line2 = f"{state_str} Set:{self.setPoint}F"
            ...
            if ((counter % 30) == 0):
                ...
                ## Remove this TODO comment block when complete.
                ##
                output_str = self.setupSerialOutput()
                ser.write(f"{output_str}\n".encode())
                counter = 1
            else:
                counter = counter + 1
            sleep(1)
